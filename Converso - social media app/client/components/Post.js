      ...
      <div className={style.postMain}>
        <div className="h-[570px] w-[550px]  pl-[70px]">
          ...
          <div className="max-w-md bg-[#6576833d] rounded-lg shadow-2xl shadow-black overflow-hidden h-[500px] w-[500px] pl-[50px] pr-[50px] pt-[30px] ">
            {postImage && <div className="relative  border-black-500px">
              <img
                src={postImage}
                alt="nft"
                className="w-full h-auto border-solid border-2 border-black-500px"
              />
            </div>
          }
          {console.log(postImage)}
            <div className="p-3">
              <div className="flex items-center mt-2">
                {" "}
                <span>
                  <h2 className="text-xl font-semibold">NFT-newly minted. </h2>
                </span>
                <span>
                  <img
                    src="./profile/bluetic2.png"
                    alt="Blue Tick"
                    className="w-7 h-4 mr-1"
                  />
                </span>
              </div>
        ...
        <div className={style.footer}>
          <div
            className={`${style.footerIcon} hover:bg-[#F9EEFB] hover:text-[#1d9bf0]`}
          >
            <FaRegComment />
          </div>
          <div
